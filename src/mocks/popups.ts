...
export const mockPopups: PopupItem[] = [
  ...
  },
  {
    ...
    endDate: '2026-06-28',
    description:
      '크롤링 데이터에 좌표가 누락된 상황을 확인하기 위한 mock 데이터입니다. 지도에는 표시되지 않고 카드 정보만 표시됩니다.',
    weeklyViewCount: 620,
    favoriteCount: 72,
  ...
  {
    id: 6,
    name: '이미지 없는 라이프스타일 팝업',
    title: '이미지 없는 라이프스타일 팝업',
    ...
    endDate: '2026-07-10',
    description: '크롤링 데이터에 이미지가 없는 상황을 확인하기 위한 mock 데이터입니다.',
    weeklyViewCount: 410,
    favoriteCount: 51,
    images: [],
    thumbnail: null,
